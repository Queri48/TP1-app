    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin.articles.modifier_traitement', $article->id) }}">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="article_description" name="article_description" rows="3" cols="40" required></textarea>
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="article_tags" name="article_tags" value="" required>
                    @error('tags')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
